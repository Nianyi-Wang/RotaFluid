...
class Trainer:
    ...
    def __init__(
        ...
        self._log_dir = os.path.join(root_dir, 'logs') #train_network_torch_default
    ...
    def keep_training(
        ...
        stop_step         : int or list of int
                            ...
                            that need to call the training script multiple times. #迭代多少次停止
        ...
        stop_time          : float or None
                             ...
                             Set to None for no stop_time or do not set the env var STOP_TIME. #过多少秒停止
