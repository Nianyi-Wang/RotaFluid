...
from create_physics_fueltank_zh_69r_rotate import create_custom_simulation
...
def batch_run_simulations(fluid_models_dir, dynamic_models_dir, output_base_dir):
    ...
    dynamic_models = ["/home/zh/fueltank_datasets/models/fueltank/tank69r.obj"]
    ...
    fluid_models = ["/home/zh/fueltank_datasets/models/fueltank/fluid_50_69r.obj"]
    if not fluid_models:
