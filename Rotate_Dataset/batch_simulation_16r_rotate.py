...
from create_physics_fueltank_zh_16_rotate import create_custom_simulation
...
def batch_run_simulations(fluid_models_dir, dynamic_models_dir, output_base_dir):
    ...
    dynamic_models = ["/home/zh/fueltank_datasets/models/fueltank/tank16.obj"]
    ...
    fluid_models = ["/home/zh/fueltank_datasets/models/fueltank/fluid_40_16.obj"]
    if not fluid_models:
