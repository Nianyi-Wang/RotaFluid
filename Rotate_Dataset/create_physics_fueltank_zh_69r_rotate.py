...
def main():
    ...
    # 设置参数
    dynamic_model = "/home/zh/fueltank_datasets/models/fueltank/tank69r.obj"
    fluid_model = "/home/zh/fueltank_datasets/models/fueltank/fluid_50_69r.obj"
    # rotation_seq =   [0.0,0.0, 1.0,0.0, 1.01,0.27596,2.0,0.27596,2.01,0.0]  # [t0, s0, t1, s1, t2, s2]
    rotation_seq =   [ 0.0, 0.0, 1.0, 0.523599, 2.0, 0.0]  # [t0, s0, t1, s1, t2, s2]
    normal_vec =  [1.0, 0.0, 0.0] # 旋转轴法向量
    output_dir = "/home/zh/fueltank_datasets/output/rotate_69r_test_025_baoxian"
    os.makedirs(output_dir, exist_ok=True)
